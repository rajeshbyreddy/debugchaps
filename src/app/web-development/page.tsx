          ...
          <div className="animate-fade-in-up">
            ...
            <div className="mb-4 sm:mb-6">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light text-gray-300 leading-tight font-poppins px-2">
                Master frontend and backend interview questions
              </h2>
              <div className="mt-2">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-8 sm:mb-12 text-gray-400 max-w-4xl mx-auto leading-relaxed font-inter font-light px-4">
              Prepare for web development interviews with comprehensive guides covering React, Next.js, Node.js, databases, and modern web technologies.
            </p>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent font-montserrat px-2">Interview Topics</h2>
            <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto font-poppins font-light px-4">Master the key areas tested in web development interviews</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="group bg-gradient-to-br from-gray-900 to-gray-800 p-6 sm:p-8 rounded-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/10 backdrop-blur-sm">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-blue-300 transition-colors duration-300 font-playfair">Frontend Interview Questions</h3>
              <p className="text-gray-400 leading-relaxed font-inter font-normal text-sm sm:text-base mb-4">Master React, JavaScript, HTML, CSS, and modern frontend frameworks with comprehensive Q&A guides.</p>
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-center gap-2">
                  <FaCheckCircle className="text-green-400 text-xs" />
                  <span>React hooks and lifecycle</span>
                </li>
                <li className="flex items-center gap-2">
                  <FaCheckCircle className="text-green-400 text-xs" />
            ...
            <div className="group bg-gradient-to-br from-gray-900 to-gray-800 p-6 sm:p-8 rounded-2xl border border-gray-700 hover:border-green-500/50 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-green-500/10 backdrop-blur-sm">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-green-300 transition-colors duration-300 font-playfair">Backend Interview Questions</h3>
              <p className="text-gray-400 leading-relaxed font-inter font-normal text-sm sm:text-base mb-4">Deep dive into Node.js, Express, REST APIs, databases, and server-side development concepts.</p>
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-center gap-2">
                  <FaCheckCircle className="text-green-400 text-xs" />
            ...
            <div className="group bg-gradient-to-br from-gray-900 to-gray-800 p-6 sm:p-8 rounded-2xl border border-gray-700 hover:border-purple-500/50 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/10 backdrop-blur-sm">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-purple-300 transition-colors duration-300 font-playfair">Web Performance & Optimization</h3>
              <p className="text-gray-400 leading-relaxed font-inter font-normal text-sm sm:text-base mb-4">Learn about web performance, optimization techniques, and best practices for scalable applications.</p>
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-center gap-2">
                  <FaCheckCircle className="text-green-400 text-xs" />
                  <span>Loading optimization</span>
                </li>
                <li className="flex items-center gap-2">
                  <FaCheckCircle className="text-green-400 text-xs" />
            ...
            <div className="group bg-gradient-to-br from-gray-900 to-gray-800 p-6 sm:p-8 rounded-2xl border border-gray-700 hover:border-pink-500/50 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/10 backdrop-blur-sm">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-pink-300 transition-colors duration-300 font-playfair">Web Security Interview Questions</h3>
              <p className="text-gray-400 leading-relaxed font-inter font-normal text-sm sm:text-base mb-4">Master web security concepts, common vulnerabilities, and secure coding practices.</p>
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-center gap-2">
                  <FaCheckCircle className="text-green-400 text-xs" />
