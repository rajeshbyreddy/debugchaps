              ...
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed bg-white dark:bg-gray-700 p-6 rounded-lg border-l-4 border-blue-500 shadow-sm">
                {item.answer.split('\n').map((line, i) => {
                  ...
                  const highlightedLine = line
                    .replace(/\b(HLD|LLD|CAP Theorem|Latency|Throughput|Scalability|Availability|Performance|Consistency|Partition Tolerance|Monolithic|Microservices|Stateless|Stateful|Synchronous|Asynchronous|SPOF|Load Balancing|Caching|Proxy|Database|Indexing)\b/g, '<span class="bg-blue-200 dark:bg-blue-800 text-blue-900 dark:text-blue-100 px-2 py-1 rounded font-semibold">$1</span>')
