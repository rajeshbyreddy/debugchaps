...
import { FaGraduationCap, FaChevronDown, FaChevronRight, FaDatabase, FaTable, FaKey, FaLink, FaCogs, FaLock, FaRocket, FaServer, FaShieldAlt, FaExchangeAlt, FaCloud, FaCode, FaSync, FaBars, FaTimes } from 'react-icons/fa';
  ...
  const content = [
    {
      ...
      keyPoints: ['Organized data collection', 'Electronic storage', 'Efficient data management', 'Structured information']
    },
    {
      id: 'dbms-concept',
      ...
      keyPoints: ['Database software', 'Data management', 'User interface', 'Application interaction']
    },
    {
      id: 'dbms-vs-rdbms',
            ...
            <div className="fixed left-0 top-0 h-full w-80 bg-black/95 backdrop-blur-xl border-r border-cyan-500/20 shadow-2xl overflow-y-auto">
              <div className="p-6">
                ...
                <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-sm border border-cyan-500/20 rounded-xl p-4 mb-8 shadow-lg">
                  <h3 className="text-sm font-semibold text-gray-300 mb-2">Database Management Systems Progress</h3>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 lg:mb-12">
            ...
            <p className="text-base lg:text-lg text-gray-400 leading-relaxed">
              Master database concepts, SQL, normalization, and database design for technical interviews.
            </p>
          </div>
