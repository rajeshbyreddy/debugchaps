              ...
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed bg-white dark:bg-gray-700 p-6 rounded-lg border-l-4 border-blue-500 shadow-sm">
                {item.answer.split('\n').map((line, i) => {
                  ...
                  const highlightedLine = line
                    .replace(/\b(Process|Thread|Scheduling|Context Switching|Memory Management|Virtual Memory|Paging|Segmentation|Deadlock|Semaphore|Mutex|Critical Section|Race Condition|Starvation|File System|Buffering|Spooling|IPC|System Call|Kernel|Device Driver|Virtual Machine|Shell|FCFS|SJF|Round Robin)\b/g, '<span class="bg-blue-200 dark:bg-blue-800 text-blue-900 dark:text-blue-100 px-2 py-1 rounded font-semibold">$1</span>')
                    .replace(/\b(\d+(?:\.\d+)?%|\d+ milliseconds?|\d+ seconds?|\d+ minutes?|\d+ hours?|\d+ (GB|MB|KB))\b/g, '<span class="bg-green-200 dark:bg-green-800 text-green-900 dark:text-green-100 px-2 py-1 rounded font-semibold">$1</span>')
